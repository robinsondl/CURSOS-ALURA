...
Digite o seu peso (kg): 75
Digite su altura (m): 1.68
Seu IMC é: 26.57
Você está acima do peso.

'''

print('Exercício 4 - Calculando o IMC.\n')
...
if imc < 18.5:
    print(f'\nDe acordo com o seu IMC: {imc:.2f}, você está abaixo do peso.')
elif 18.5 <= imc < 25:
    print(f'\nDe acordo com o seu IMC: {imc:.2f}, você está no peso ideal.')
else:
    print(f'\nDe acordo com o seu IMC: {imc:.2f}, você está acima do peso ideial.')